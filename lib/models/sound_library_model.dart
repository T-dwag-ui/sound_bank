...
class SoundLibraryData {
  ...
  //   AudioPluginDefinition(
  //     id: 'alchemy',
  //     name: 'Alchemy Sound Synthesizer',
  //     category: 'Instrument',
  //     description: 'Logic Pro flagship sample-manipulation synthesizer.',
  //     icon: Icons.blur_on_rounded,
  //     parameters: [
  //       PluginParameter(name: 'Cutoff', value: 0.75, unit: 'kHz'),
  //       PluginParameter(name: 'Resonance', value: 0.40, unit: '%'),
  //       PluginParameter(name: 'Morph XY', value: 0.60, unit: '%'),
  //       PluginParameter(name: 'LFO Rate', value: 0.25, unit: 'Hz'),
  //     ],
  //   ),
  //   AudioPluginDefinition(
  //     id: 'drum_machine_designer',
  //     name: 'Drum Machine Designer',
  //     category: 'Instrument',
  //     description: 'Custom pad sampler & electronic drum kit engine.',
  //     icon: Icons.grid_view_rounded,
  //     parameters: [
  //       PluginParameter(name: 'Drive', value: 0.35, unit: '%'),
  //       PluginParameter(name: 'Pitch Shift', value: 0.50, unit: 'st'),
  //       PluginParameter(name: 'Decay', value: 0.65, unit: 's'),
  //     ],
  //   ),
  //   AudioPluginDefinition(
  ...
  //     category: 'Instrument',
  //     description: 'Classic tonewheel organ with rotary speaker cabinet.',
  //     icon: Icons.music_note_rounded,
  //     parameters: [
  //       PluginParameter(name: 'Rotor Speed', value: 0.80, unit: 'RPM'),
  //       PluginParameter(name: 'Drive', value: 0.30, unit: '%'),
  //       PluginParameter(name: 'Percussion Level', value: 0.55, unit: 'dB'),
  //     ],
  //   ),
  //   AudioPluginDefinition(
  //     id: 'vintage_keys',
  ...
  //     category: 'Instrument',
  //     description: 'Modelled Rhodes & Wurlitzer electric pianos.',
  //     icon: Icons.piano_rounded,
  //     parameters: [
  //       PluginParameter(name: 'Tremolo Depth', value: 0.45, unit: '%'),
  //       PluginParameter(name: 'Chorus Mix', value: 0.30, unit: '%'),
  //       PluginParameter(name: 'Drive', value: 0.20, unit: '%'),
  //     ],
  //   ),
  ...
  //     name: 'ChromaVerb',
  //     category: 'Reverb',
  //     description: 'Logic Pro high-end algorithmic reverb with colorful spectrum visualizer.',
  //     icon: Icons.graphic_eq_rounded,
  //     parameters: [
  //       PluginParameter(name: 'Decay Time', value: 0.60, unit: 's'),
  //       PluginParameter(name: 'Mix', value: 0.35, unit: '%'),
  //       PluginParameter(name: 'Pre-Delay', value: 0.15, unit: 'ms'),
  //       PluginParameter(name: 'Damping', value: 0.50, unit: '%'),
  //     ],
  //   ),
  //   AudioPluginDefinition(
  //     id: 'space_designer',
  //     name: 'Space Designer',
  //     category: 'Reverb',
  //     description: 'Convolution reverb sampling real acoustics & halls.',
  //     icon: Icons.surround_sound_rounded,
  //     parameters: [
  //       PluginParameter(name: 'IR Length', value: 0.70, unit: '%'),
  //       PluginParameter(name: 'Dry/Wet', value: 0.40, unit: '%'),
  //     ],
  //   ),
  //   AudioPluginDefinition(
  //     id: 'stereo_delay',
  //     name: 'Stereo Delay',
  //     category: 'Delay',
  //     description: 'Dual channel tempo-synced delay line.',
  //     icon: Icons.hourglass_bottom_rounded,
  //     parameters: [
  //       PluginParameter(name: 'Left Delay', value: 0.25, unit: '1/8d'),
  //       PluginParameter(name: 'Right Delay', value: 0.33, unit: '1/4'),
  //       PluginParameter(name: 'Feedback', value: 0.40, unit: '%'),
  //     ],
  //   ),
  ...
  //     name: 'Channel EQ',
  //     category: 'EQ',
  //     description: '8-band parametric EQ with real-time analyzer.',
  //     icon: Icons.equalizer_rounded,
  //     parameters: [
  //       PluginParameter(name: 'High Cut', value: 0.90, unit: 'kHz'),
  //       PluginParameter(name: 'Low Cut', value: 0.10, unit: 'Hz'),
  ...
  //   AudioPluginDefinition(
  //     id: 'logic_compressor',
  //     name: 'Logic Studio Compressor',
  //     category: 'Dynamics',
  //     description: '7 circuit models (Platinum, VCA, FET, Opto, Vintage Class A).',
  //     icon: Icons.compress_rounded,
  //     parameters: [
  //       PluginParameter(name: 'Threshold', value: 0.40, unit: 'dB'),
  //       PluginParameter(name: 'Ratio', value: 0.60, unit: ':1'),
  ...
  //     name: 'Amp Designer',
  //     category: 'Guitar/Amp',
  //     description: 'Modelling vintage guitar amplifiers & speaker cabinets.',
  //     icon: Icons.speaker_rounded,
  //     parameters: [
  //       PluginParameter(name: 'Gain', value: 0.70, unit: '%'),
  //       PluginParameter(name: 'Bass', value: 0.50, unit: '%'),
  //       PluginParameter(name: 'Treble', value: 0.65, unit: '%'),
  //       PluginParameter(name: 'Presence', value: 0.45, unit: '%'),
  //     ],
  //   ),
  //   AudioPluginDefinition(
  //     id: 'bass_amp_designer',
  //     name: 'Bass Amp Designer',
  //     category: 'Guitar/Amp',
  //     description: 'Deep sub & tube bass amplifier modeler.',
  //     icon: Icons.speaker_group_rounded,
  //     parameters: [
  //       PluginParameter(name: 'Sub Drive', value: 0.60, unit: '%'),
  //       PluginParameter(name: 'Compressor', value: 0.45, unit: '%'),
  //     ],
  //   ),
  // ];

   final List<SoundLibraryPreset> presets = [
    // Logic Pro Drums
    const SoundLibraryPreset(
      id: 'lp_d1',
      name: 'SoCal Producer Drum Kit',
      category: 'Drums',
      source: DawSource.logicPro,
      icon: Icons.grid_view_rounded,
      themeColor: Color(0xFFF59E0B),
      description: 'Warm analog studio drum kit recorded in Los Angeles.',
      defaultPlugins: ['Drum Kit Designer', 'Logic Studio Compressor', 'Channel EQ'],
      defaultTrackType: 'Audio',
    ),
    const SoundLibraryPreset(
      id: 'lp_d2',
      name: 'Cyberpunk 808 Trap Kit',
      category: 'Drums',
      source: DawSource.logicPro,
      icon: Icons.space_dashboard_rounded,
      themeColor: Color(0xFF06B6D4),
      description: 'Heavy sub-bass kicks, crisp snares, & pitch hi-hats.',
      defaultPlugins: ['Drum Machine Designer', 'Overdrive', 'Stereo Delay'],
      defaultTrackType: 'MIDI',
    ),
    const SoundLibraryPreset(
      id: 'gb_d1',
      name: 'GarageBand Stadium Rock Drums',
      category: 'Drums',
      source: DawSource.garageBand,
      icon: Icons.album_rounded,
      themeColor: Color(0xFFEF4444),
      description: 'Punchy arena drums with ambient room reverb.',
      defaultPlugins: ['Studio Drums', 'ChromaVerb'],
      defaultTrackType: 'Audio',
    ),

    // Logic Pro & GarageBand Synths & Keys
    const SoundLibraryPreset(
      id: 'lp_s1',
      name: 'Alchemy Evolving Cyber Ambient Pad',
      category: 'Synth',
      source: DawSource.logicPro,
      icon: Icons.blur_on_rounded,
      themeColor: Color(0xFF10B981),
      description: 'Deep lush atmospheric synth pad with motion LFO.',
      defaultPlugins: ['Alchemy', 'ChromaVerb', 'Stereo Delay'],
      defaultTrackType: 'MIDI',
    ),
    const SoundLibraryPreset(
      id: 'lp_s2',
      name: 'ES2 Synth 80s Synthwave Lead',
      category: 'Synth',
      source: DawSource.logicPro,
      icon: Icons.piano_rounded,
      themeColor: Color(0xFF22C55E),
      description: 'Iconic retro sawtooth lead with tape chorus.',
      defaultPlugins: ['ES2 Synth', 'Distortion', 'Tape Delay'],
      defaultTrackType: 'MIDI',
    ),
    const SoundLibraryPreset(
      id: 'gb_k1',
      name: 'GarageBand Classic Suitcase Mark I',
      category: 'Keys',
      source: DawSource.garageBand,
      icon: Icons.piano,
      themeColor: Color(0xFF14B8A6),
      description: 'Warm electric piano with vintage stereo tremolo.',
      defaultPlugins: ['Vintage Electric Piano', 'Chorus'],
      defaultTrackType: 'MIDI',
    ),
    const SoundLibraryPreset(
      id: 'lp_k2',
      name: 'Vintage B3 Organ Groove',
      category: 'Keys',
      source: DawSource.logicPro,
      icon: Icons.music_note_rounded,
      themeColor: Color(0xFF84CC16),
      description: 'Full drawbar organ with fast Leslie speaker rotor.',
      defaultPlugins: ['Vintage B3 Organ', 'Channel EQ'],
      defaultTrackType: 'MIDI',
    ),
    ...
    const SoundLibraryPreset(
      id: 'lp_o1',
      name: 'Logic Studio Strings Ensemble',
      category: 'Strings',
      source: DawSource.logicPro,
      icon: Icons.music_video_rounded,
      themeColor: Color(0xFF3B82F6),
      description: 'Full 50-piece orchestral string section.',
      defaultPlugins: ['Studio Strings', 'Space Designer', 'Channel EQ'],
      defaultTrackType: 'MIDI',
    ),
    const SoundLibraryPreset(
      id: 'gb_o2',
      name: 'GarageBand Cinematic Cello Solo',
      category: 'Strings',
      source: DawSource.garageBand,
      icon: Icons.graphic_eq_rounded,
      themeColor: Color(0xFF6366F1),
      description: 'Expressive solo cello with natural vibrato.',
      defaultPlugins: ['Studio Strings', 'ChromaVerb'],
      defaultTrackType: 'MIDI',
    ),
    ...
    const SoundLibraryPreset(
      id: 'lp_g1',
      name: 'Amp Designer British Stack Shred',
      category: 'Guitar',
      source: DawSource.logicPro,
      icon: Icons.speaker_rounded,
      themeColor: Color(0xFF8B5CF6),
      description: 'High-gain British tube head & 4x12 cab.',
      defaultPlugins: ['Amp Designer', 'Stereo Delay', 'Logic Studio Compressor'],
      defaultTrackType: 'Audio',
    ),
    const SoundLibraryPreset(
      id: 'lp_b1',
      name: 'Slap Funk Bass & Bass Amp Designer',
      category: 'Bass',
      source: DawSource.logicPro,
      icon: Icons.graphic_eq,
      themeColor: Color(0xFFD946EF),
      description: 'Punchy active slap bass with sub-boost.',
      defaultPlugins: ['Bass Amp Designer', 'Logic Studio Compressor'],
      defaultTrackType: 'Audio',
    ),
    const SoundLibraryPreset(
      id: 'gb_b2',
      name: 'GarageBand Deep 808 Sub Bass',
      category: 'Bass',
      source: DawSource.garageBand,
      icon: Icons.subtitles_rounded,
      themeColor: Color(0xFFEC4899),
      description: 'Clean sine-wave sub bass for Hip Hop & R&B.',
      defaultPlugins: ['ES2 Synth', 'SubBass'],
      defaultTrackType: 'MIDI',
    ),
    ...
    const SoundLibraryPreset(
      id: 'lp_v1',
      name: 'Logic Cyberpunk Vocoder Vox',
      category: 'Vox',
      source: DawSource.logicPro,
      icon: Icons.record_voice_over_rounded,
      themeColor: Color(0xFF4F46E5),
      description: 'Robotic harmonies synced to MIDI track notes.',
      defaultPlugins: ['EVOC 20 Vocoder', 'Channel EQ', 'ChromaVerb'],
      defaultTrackType: 'Audio',
    ),
  ];
